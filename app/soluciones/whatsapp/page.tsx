...
export const metadata: Metadata = {
  title: "Demo Agente WhatsApp — INERTI",
  description:
    "Mira en vivo cómo el agente de WhatsApp con IA de INERTI responde clientes de forma automática. Elige un rubro y pruébalo tú mismo.",
};
        ...
        <section className="pb-6 pt-24 md:pt-32">
          <div className="mx-auto max-w-[1120px] px-5 md:px-8">
            ...
            <h1 className="mb-6 font-[family-name:var(--font-barlow)] text-4xl font-black leading-[1.08] tracking-tight md:text-6xl">
              Agente de <span className="gradient-text">WhatsApp</span> con IA
            </h1>
            <p className="max-w-2xl text-lg leading-relaxed text-[#7a8ba5]">
              Un asistente con IA en tu WhatsApp que responde preguntas, entrega precios, gestiona
              stock y agenda citas — 24/7, sin intervención humana.
            </p>
          </div>
        </section>
        ...
        <section className="border-t border-white/[0.06] py-20 md:py-24">
          <div className="mx-auto max-w-[1120px] px-5 md:px-8">
            <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
              {[
                { icon: "🕐", title: "Responde 24/7", text: "Tu negocio nunca duerme. Responde clientes a las 3 AM sin que tú estés." },
                { icon: "💬", title: "Mensajes ilimitados", text: "Sin cobro por conversación. Todas las consultas que lleguen, resueltas." },
                { icon: "⚡", title: "Listo en 5 días", text: "Nos encargamos de todo. Tu asistente opera en días, no semanas." },
              ].map((b) => (
                <div
                  key={b.title}
        ...
        <section className="py-16 text-center">
          <div className="mx-auto max-w-[600px] px-5">
            ...
            <p className="mb-8 text-[#7a8ba5]">
              Te mostramos cómo se adapta a tu rubro específico en una videollamada de 15 minutos. Sin compromiso.
            </p>
            <a
