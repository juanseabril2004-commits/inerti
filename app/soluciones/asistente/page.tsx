...
export const metadata: Metadata = {
  title: "Demo Asistente Personal — INERTI",
  description:
    "Mira en vivo cómo tu IA privada resume ventas, mensajes, citas y leads cada mañana. Te avisa lo importante antes de que lo pidas.",
};
      ...
      <main className="flex-1">
        ...
        <section className="pb-6 pt-24 md:pt-32">
          <div className="mx-auto max-w-[1120px] px-5 md:px-8">
            ...
            <span className="mb-4 block text-xs font-semibold uppercase tracking-[0.1em] text-[#8b5cf6]">
              🧠 Nuevo módulo
            </span>
            <h1 className="mb-6 font-[family-name:var(--font-barlow)] text-4xl font-black leading-[1.08] tracking-tight md:text-6xl">
              Asistente <span className="gradient-text">Personal</span> con IA
            </h1>
            <p className="max-w-2xl text-lg leading-relaxed text-[#7a8ba5]">
              Tu IA privada que resume ventas, mensajes, citas y leads cada mañana.
              Te avisa lo importante antes de que lo pidas.
            </p>
          </div>
        </section>
        ...
        <section className="border-t border-white/[0.06] py-20 md:py-24">
          <div className="mx-auto max-w-[1120px] px-5 md:px-8">
            <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
              {[
                { icon: "📊", title: "Resumen matutino", text: "Cada mañana recibes un dashboard con lo que importa: ventas, citas, leads y alertas." },
                { icon: "🔔", title: "Alertas proactivas", text: "Te avisa antes de que algo se queme: urgencias sin responder, pagos pendientes, stock bajo." },
                { icon: "💬", title: "Conversación natural", text: "Pregunta lo que quieras como si hablaras con un socio. Sin reportes, sin dashboards complejos." },
              ].map((b) => (
                <div
                  key={b.title}
        ...
        <section className="py-16 text-center">
          <div className="mx-auto max-w-[600px] px-5">
            ...
            <a
              ...
              className="inline-flex items-center justify-center rounded-[10px] bg-[#8b5cf6] px-9 py-4 text-lg font-semibold text-white shadow-[0_2px_8px_rgba(139,92,246,0.2)] transition-all hover:-translate-y-0.5 hover:bg-[#a78bfa]"
            >
